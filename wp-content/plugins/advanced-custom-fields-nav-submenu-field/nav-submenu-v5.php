...
/**
 * ACF_Field_Nav_Submenu_V5 Class
 *
 * This class contains all the custom workings for the Nav Submenu Field for ACF v5
 * Based on the Nav Menu Field for ACF v5
 */
class ACF_Field_Nav_Submenu_V5 extends acf_field {
	...
	public function render_field_settings( $field ) {
		...
		// Register the Parent Menu setting
		acf_render_field_setting( $field, array(
			'label'        => __( 'Parent Menu' ),
			'instructions' => __( "Parent Menu of the Submenu list that will be available for the user" ),
			'type'         => 'select',
			'name'         => 'parent_menu',
