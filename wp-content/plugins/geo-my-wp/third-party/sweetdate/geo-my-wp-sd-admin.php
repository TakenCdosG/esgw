...
class GMW_SD_Admin {
    ...
    public function admin_js() {
    	wp_enqueue_script( 'sd-admin-js', GMW_URL . '/third-party/sweetdate/assets/js/js-admin.js', array( 'jquery' ), false );
    }
    	...
    	$settings['sweet_date'] = array(
    			...
    			array(
    					'status'     => array(
    							'name'     => 'status',
    							'std'      => '',
    							'label'    => __( 'Enable Sweet-Date integration?', 'GMW' ),
    							'cb_label' => __( 'Enable', 'GMW' ),
    							'desc'     => __( 'Enable/disable GEO my WP integration with Sweet-Date members page.', 'GMW' ),
    							'type'     => 'checkbox'
    					),
